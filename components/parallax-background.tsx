...
export function ParallaxBackground() {
  ...
  const y6 = useTransform(scrollYProgress, [0, 1], ["0%", "-20%"]);
    ...
    <div ref={ref} className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
      ...
      <motion.div
        style={{ 
          ...
          opacity: useTransform(scrollYProgress, [0, 0.3, 0.7, 1], [0.3, 0.1, 0.2, 0.4])
        }}
      ...
      <motion.div
        style={{ 
          opacity: useTransform(scrollYProgress, [0, 0.5, 1], [0.1, 0.05, 0.15]),
